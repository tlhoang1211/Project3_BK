...
@section('content')
    <main class="bg_gray">
        ...
        <div class="top_banner general" style="height: 400px">
            ...
            <img
                src="https://res.cloudinary.com/vernom/image/upload/c_scale,h_180,w_600/v1596970692/perfume_project/service/payment_aiyb5t.jpg"
        ...
        <div class="container margin_30">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="list_choice"><a href="/payment_methods" style="color: #3a87ad">4. Phương thức thanh
                            toán</a></div>
                    <div class="list_choice"><a href="/policy">5. Chính sách</a></div>
                </div>
                <div class="col-md-9">
                    <button class="collapsible_faq"><strong style="font-size: 17px">Phương thức thanh toán</strong>
                    </button>
                    <div class="content_faq">
                        <p>Đối với các đơn hàng tại Hà Nội:</p>
                        <ul>
                            <li>Tại showroom: Chúng tôi chấp nhận hình thức thanh toán bằng tiền mặt, Chuyển khoản, các
                                loại
                                thẻ ATM, VISA, Mastercard nội địa
                            </li>
                            <li>Ship tại TP HN: Chúng tôi chấp nhận hình thức Ship COD (nhận hàng mới đưa tiền) hoặc
                                chuyển khoản trước khi Ship
                            </li>
                        </ul>

                        <p>Đối với các đơn hành tại Tỉnh:</p>
                        <ul>
                            <li>
                                Wanderlust áp dụng hình thức chuyển khoản trước cho các đơn hàng tỉnh, không áp dụng
                                Ship COD
                            </li>
                        </ul>
                    </div>
