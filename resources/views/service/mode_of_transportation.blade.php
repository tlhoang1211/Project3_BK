...
@section('content')
    <main class="bg_gray">
        ...
        <div class="top_banner general" style="height: 400px">
            ...
            <img
                src="https://res.cloudinary.com/vernom/image/upload/c_scale,h_130,w_355/v1596969851/perfume_project/service/ship_tw9b4t.jpg"
        ...
        <div class="container margin_30">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="list_choice"><a href="/mode_of_transportation" style="color: #3a87ad">3. Phương thức vận
                            chuyển</a></div>
                ...
                <div class="col-md-9">
                    <button class="collapsible_faq"><strong style="font-size: 17px">Phương thức
                            vận
                            chuyển</strong>
                    </button>
                    <div class="content_faq">
                        <p>Đối với các đơn trong phạm vi Hà Nội, các đơn hàng có thể chọn phương thức
                            thanh toán COD hoặc chuyển khoản, namperfume cam kết các quận trung tâm sẽ được ship hàng
                            trong 3 giờ kể từ khi chốt đơn đối với những đơn hàng trong ngày từ khung giờ 9.00 am đến
                            15.00 pm. Nếu bạn muốn ship hẹn giờ, liên hệ hotline <b>+84 123-456-789</b> hoặc fangape
                            facebook,
                            instagram của chúng tôi để được hỗ trợ.

                            Đối với các đơn hàng Tỉnh (ngoài Hà Nội), namperfume thực hiện lên đơn hàng
                            và thanh toán với cách thức chuyển khoản trước. Sau khi chúng tôi xác nhận được sao kê số
                            tiền, đơn hàng của bạn sẽ được đóng gói và vận chuyển trong vòng 2-4 ngày (không tính cuối
                            tuần và ngày lễ)</p>
                    </div>
                </div>
            </div>
