...
@section('content')
    <main class="bg_gray">
        ...
        <div class="top_banner general" style="height: 400px">
            ...
            <img
                src="https://res.cloudinary.com/vernom/image/upload/c_scale,h_350,w_939/v1596970695/perfume_project/service/policy_bq8dge.png"
        ...
        <div class="container margin_30">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="list_choice"><a href="/ordering_guide">2. Hướng dẫn đặt hàng</a>
                    </div>
                    ...
                    <div class="list_choice"><a href="/policy" style="color: #3a87ad">5. Chính sách</a></div>
                </div>
                <div class="col-md-9">
                    <button class="collapsible_faq"><strong style="font-size: 17px">Chính sách bảo mật</strong>
                    </button>
                    <div class="content_faq">
                        <p><span style="font-size: 15px"><b>1.Mục đích:</b></span>
                            <br>
                            Hiện nay, vấn đề bảo mật thông tin đã trở thành vấn đề nóng trên tất cả các diễn đàn, điều
                            này không chỉ gây khó khăn cho các tổ chức, cá nhân tham gia truy cập và giao dịch mà còn
                            gây nên những phiền toái vượt ra ngoài tầm kiểm soát của hệ thống.
                            <br><br>
                            Chính sách bảo mật và chia sẻ thông tin khách hàng của wanderlust.net như một lời cam kết
                            với mong muốn nâng cao chất lượng dịch vụ, bảo đảm an toàn thông tin của các cá nhân, tổ
                            chức khi tham gia truy cập hoặc giao dịch trực tiếp trên website wanderlust.net. Chúng tôi
                            hiểu bảo vệ và sử dụng hợp lí thông tin của bạn cũng chính là bảo vệ lòng tin và sự yêu mến
                            của bạn dành cho chúng tôi.
                            <br><br>
                            <span style="font-size: 15px"><b>2. Các điều khoản áp dụng:</b></span>
                            <br>
                            2.1. Cập nhật thông tin khách hàng:
                            <br>
                            - Khi tham gia mở tài khoản hoặc giao dịch trực tiếp trên wanderlust.net, khách hàng cần
                            phải cung cấp đầy đủ các thông tin bắt buộc bao gồm tên, địa chỉ, số điện thoại... cụ thể để
                            có thể đáp ứng các điều kiện giao dịch cần thiết.
                            <br>
                            - Các thông tin cá nhân quý khách cung cấp cho wanderlust.net cần đảm bảo độ chính xác và
                            đầy đủ để phòng tránh trường hợp nhầm lẫn hoặc giả mạo. Mọi sự sai sót hoặc không chính xác
                            trong thông tin được cung cấp sẽ ảnh hưởng trực tiếp đến quyền lợi của quý khách hàng. Do
                            đó, wanderlust.net sẽ không chịu trách nhiệm đối với những tranh chấp phát sinh có liên quan
                            trong trường hợp này.
                            <br><br>
                            2.2. Lưu giữ và bảo mật thông tin khách hàng
                            <br>
                            - Tất cả các thông tin khách hàng cung cấp và nội dung giao dịch đều được wanderlust.net lưu
                            giữ bảo mật tuyệt đối trên hệ thống. wanderlust.net cam đoan sẽ không bán hoặc chia sẻ dẫn
                            đến làm lộ thông tin cá nhân của bạn, không vì những mục đích thương mại mà vi phạm cam kết
                            của chúng tôi ghi trong chính sách bảo mật này
                            <br>
                            - Wanderlust.net luôn sẵn sàng về đội ngũ kĩ thuật và an ninh để có những biện pháp đối phó
                            với những trường hợp cố tình xâm nhập và sử dụng trái phép thông tin của khách hàng. Khi thu
                            thập dữ liệu, wanderlust.net thực hiện lưu giữ và bảo mật thông tin khách hàng tại hệ thống
                            máy chủ và các thông tin khách hàng này được bảo đảm an toàn bằng các hệ thống bảo vệ tốt
                            nhất hiện nay, cùng các biện pháp kiểm soát truy cập và mã hóa dữ liệu.
                            <br>
                            - Khách hàng không được phép sử dụng bất kì chương trình hay công cụ nào nhằm mục đích khai
                            thác, thay đổi dữ liệu bất hợp pháp trên hệ thống wanderlust.net. Mọi hành vi cố tình xâm
                            phạm, tùy theo tính chất sự việc, chúng tôi có quyền khởi tố với các cơ quan có thẩm quyền
                            theo quy định pháp luật hiện hành.
                            <br>
                            - Khách hàng nên tự bảo vệ thông tin bảo mật của mình bằng cách không chia sẻ các thông tin
                            cá nhân cũng như các thông tin giao dịch với bên thứ ba, cẩn thận trong việc đăng nhập/đăng
                            xuất tài khoản để loại trừ những sự cố rò rỉ thông tin không đáng có.
                            <br><br>
                            2.3. Sử dụng thông tin
                            <br>
                            Wanderlust.net có quyền sử dụng hợp pháp các thông tin cá nhân của khách hàng trong các
                            trường hợp để đảm bảo quyền lợi của quý khách như:
                            <br><br>
                            -Thông báo các thông tin về dịch vụ quảng cáo, các chương trình khuyến mãi… đến khách hàng
                            theo nhu cầu và thói quen của quý khách khi truy cập
                            <br>
                            -Liên lạc và hỗ trợ khách hàng trong những trường hợp đặc biệt
                            <br>
                            -Phát hiện và ngăn chặn ngay lập tức các hành vi can thiệp hoặc phá hoại tài khoản của khách
                            hàng
                            <br><br>
                            2.4. Chia sẻ thông tin
                            <br>
                            Wanderlust.net cam kết không tiết lộ thông tin khách hàng cho bên thứ ba ngoại trừ các
                            trường hợp sau:
                            <br><br>
                            - Thực hiện theo yêu cầu của các các cá nhân, tổ chức có thẩm quyền theo quy định của pháp
                            luật
                            <br>
                            -Cần thiết phải sử dụng các thông tin để phục vụ cho việc cung cấp các dịch vụ/tiện ích cho
                            khách hàng
                            <br>
                            -Nghiên cứu thị trường và đánh giá phân tích
                            <br>
                            - Trao đổi thông tin khách hàng với đối tác hoặc đại lí phân phối để phân tích nâng cao chất
                            lượng dịch vụ
                            <br>
                            - Ngoài các trường hợp trên, khi cần phải trao đổi thông tin khách hàng cho bên thứ ba,
                            wanderlust.net sẽ thông báo trực tiếp với khách hàng và sẽ chỉ thực hiện việc trao đổi thông
                            tin khi có sự đồng thuận từ phía khách hàng.
                            <br><br>
                            <span style="font-size: 15px"><b>3. Liên hệ và giải đáp thắc mắc:</b></span>
                            <br>
                            Mọi ý kiến đóng góp/nhu cầu hỗ trợ vui lòng liên lạc
                            <br>
                            Hotline: 1900 0129
                            <br>
                            hoặc Email: t1908e@fpt.edu.vn</p>
                    </div>

                    <button class="collapsible_faq"><strong style="font-size: 17px">Chính sách vận chuyển</strong>
                    </button>
                    <div class="content_faq">
                        <p><span style="font-size: 15px"><b>TP Hà Nội</b></span>
                            <br>
                            Các đơn hàng tại Hà Nội có thể chọn phương thức thanh toán COD hoặc chuyển
                            khoản, wanderlust cam kết các quận trung tâm quý khách sẽ nhận được hàng chậm nhất trong 3
                            giờ kể từ khi chốt đơn đối với những đơn hàng trong ngày từ khung giờ 9.00 am đến 15.00 pm.
                            Nếu bạn muốn ship hẹn giờ, liên hệ với tổng đài CSKH 1900 0129 hoặc fangape Facebook,
                            Instagram của chúng tôi để được hỗ trợ.
                            <br><br>
                            <span style="font-size: 15px"><b>Các Tỉnh Khác</b></span>
                            <br>
                            Wanderlust thực hiện lên đơn hàng và thanh toán với cách thức chuyển khoản trước. Sau khi
                            chúng tôi xác nhận được sao kê số tiền, đơn hàng của bạn sẽ được đóng gói và vận chuyển đến
                            bạn trong vòng 2-4 ngày (không tính cuối tuần và ngày lễ)
                            <br><br>
                            <span style="font-size: 15px"> <b>Cách Thức Đóng Hàng</b></span>
                            <br>
                            Với các đơn hàng ship Tỉnh, các sản phẩm của bạn sẽ được đóng gói cẩn thận và kỹ lưỡng, bao
                            gồm nhiều lớp chống sốc, đóng hộp carton và dán keo dính cẩn thận kèm hóa đơn, đảm bảo các
                            sản phẩm được đến tay khách hàng của chúng tôi một cách tốt nhất.
                            <br><br>

                            <br>
                            Trong trường hợp các bạn mua tại Hà Nội cần hỗ trợ đóng hàng, hãy liên hệ
                            hotline 1900 0129 hoặc fangape Facebook, Instagram của chúng tôi để được hỗ trợ.</p>
                    </div>

                    <button class="collapsible_faq"><strong style="font-size: 17px">Chính sách đổi trả</strong></button>
                    <div class="content_faq">
                        <p>Hàng hóa wanderlust bán ra đảm bảo là hàng chính hãng 100%, chúng tôi cam kết không bán hàng
                            giả, hàng nhái, hàng không đảm bảo chất lượng.
                            <br><br>
                            <span style="font-size: 15px"><b>Chính sách đổi hàng hóa:</b></span>
                            <br>
                            Các trường hợp được đổi lại hàng hóa:
                            <br>
                            - Với những sản phẩm lỗi kết cấu sản phẩm do quá trình sản xuất của hãng, hay lỗi do vận
                            chuyển dẫn đến việc sản phẩm bị méo mó, thay đổi hình dạng, hư hỏng bộ phận vòi xịt, ống
                            xịt, bị nứt, vỡ.
                            <br><br>
                            - Đối với những sản phẩm đổi vì lý do cá nhân (tặng, được tặng), sản phẩm đổi chỉ được áp
                            dụng trong thời gian 10 ngày kể từ khi sản phẩm được bán ra. Sản phẩm đổi phải đảm bảo chưa
                            được sửa dụng, đối với hàng Full seal thì phải còn nguyên seal, đối với các sản phẩm
                            Giftset, Tester phải đảm bảo còn nguyên hộp, sản phẩm chưa bị can thiệp và sử dụng. sản phẩm
                            sẽ được chúng tôi kiểm tra lại để đảm bảo sản phẩm là hàng hóa của bên chúng tôi phân phối.
                            <br><br>
                            Các trường hợp không được áp dụng đổi lại hàng hóa:
                            <br>
                            - Sản phẩm không phải do wanderlust cung cấp, không chứng minh được nguồn gốc của sản phẩm
                            (hóa đơn, thời gian mua hàng)
                            <br>
                            ...
                            <br>
                            - Sau khi bạn đáp ứng được các điều kiện về đổi lại hàng hóa của chúng tôi, hãy liên hệ với
                            chúng tôi để được hỗ trợ.
                            <br>
                            - Sau khi tiếp nhận thông tin và check kiểm các điều kiện, nếu bạn đáp ứng đủ điều kiện,
                            chúng tôi sẽ hỗ trợ ngay và nhanh nhất cho bạn.
                            <br><br>
                            <span style="font-size: 15px"><b>Chính sách trả hàng hóa:</b></span>
                            <br>
                            ...
                            <br>
                            - Chúng tôi không chấp nhận trả lại hàng, hoàn lại tiền với các trường hợp muốn trả lại hàng
                            vì lý do cá nhân như không thích nữa, thay đổi ý định, hay các lý do cá nhân khác.
                            <br><br>
                            Quy trình trả hàng, hoàn tiền:
                            <br>
                            - Sau khi bạn đáp ứng được các điều kiện về trả lại hàng hóa của chúng tôi, hãy liên hệ với
                            chúng tôi để được hỗ trợ
                            <br>
                            - Sau khi tiếp nhận thông tin và check kiểm các điều kiện, nếu bạn đáp ứng đủ điều kiện,
                            chúng tôi sẽ hỗ trợ ngay và nhanh nhất cho bạn.</p>
                    </div>
                </div>
            </div>
        </div>
