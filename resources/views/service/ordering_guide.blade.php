...
@section('content')
    <main class="bg_gray">
        ...
        <div class="top_banner general" style="height: 400px">
            ...
            <img
                src="https://res.cloudinary.com/vernom/image/upload/v1596971433/perfume_project/service/order_nf9xpe.jpg"
        ...
        <div class="container margin_30">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="list_choice"><a href="/ordering_guide" style="color: #3a87ad">2. Hướng dẫn đặt hàng</a>
                    </div>
                ...
                <div class="col-md-9">
                    <button class="collapsible_faq"><strong style="font-size: 17px">Tôi có cần một tài khoản để đặt hàng
                            không?</strong>
                    </button>
                    <div class="content_faq">
                        <p>Không, tất cả những gì bạn cần là một địa chỉ email và số điện thoại. wanderlust khuyên bạn
                            nên đăng ký tài khoản để dễ dàng theo dõi và lưu trữ những sản phẩm yêu thích của mình. Bên
                            cạnh đó, việc đăng ký tài khoản sẽ giúp bạn tích lũy được giá trị mua hàng để nhận được
                            những chương trình ưu đãi dành cho thành viên của wanderlust.
                            <br><br>
                            Bạn cũng có thể đặt hàng và theo dõi các đơn đặt hàng với tư cách là khách và đăng ký (click
                            vào để đăng ký) vào thời điểm phù hợp với bạn</p>
                    </div>

                    <button class="collapsible_faq"><strong style="font-size: 17px">Làm cách nào để nhận email cập nhật
                            từ wanderlust</strong>
                    </button>
                    <div class="content_faq">
                        <p>Chúng tôi sẽ thông báo về những sản phẩm mới, các xu hướng về nước hoa, các chương trình
                            khuyến mãi độc quyền, ưu đãi đặc biệt qua email cho các khách hàng của mình. Hãy nhập địa
                            chỉ email của bạn ở cuối trang chủ của chúng tôi và nhận lại những điều bất ngờ và thú
                            vị.</p>
                    </div>

                    <button class="collapsible_faq"><strong style="font-size: 17px">Cách đặt hàng trên
                            wanderlust</strong></button>
                    <div class="content_faq">
                        <p>Dễ dàng thôi, chúng tôi sẽ chỉ cho bạn:
                            <br><br>
                            1. Chọn một thương hiệu hoặc danh mục (nước hoa nam, nước hoa nữ…) từ menu của Website hoặc
                            sử dụng khung tìm kiếm để khám phá một chai nước hoa cụ thể mà bạn đang tìm.
                            <br><br>
                            2. Sau khi vào được trang sản phẩm bạn đang tìm kiếm, bạn chỉ việc chọn dung tích (size) mà
                            bạn muốn mua và bấm vào MUA NGAY để thanh toán hoặc bấm vào THÊM VÀO GIỎ HÀNG để tiếp tục
                            xem thêm những sản phẩm khác.
                            <br><br>
                            3. Bạn có thể đăng nhập bằng tài khoản (nếu có) hoặc có thể tiến hành mua hàng trực tiếp
                            bằng cách nhập đầy đủ thông tin (tên, địa chỉ, số điện thoại, email) trong mục thanh toán.
                            Chúng tôi sẽ gửi email xác nhận và bộ phận CSKH sẽ gọi điện để xác nhận đơn hàng của bạn sớm
                            nhất ( trong khung giờ 9h-21h) trước khi đơn hàng được vận chuyển
                        </p>
                    </div>

                    <button class="collapsible_faq"><strong style="font-size: 17px">Tôi có thể đặt hàng qua điện thoại
                            được không?</strong></button>
                    <div class="content_faq">
                        <p>Chắc chắn rồi, đội ngũ chăm sóc khách hàng chuyên nghiệp, thân thiện của chúng tôi luôn sẵn
                            sàng phục vụ, hỗ trợ bạn 7 ngày trong tuần từ 9h đến 21h giờ hàng ngày. Gọi ngay 1900 0129
                            để chúng tôi được hỗ trợ bạn.</p>
                    </div>

                    <button class="collapsible_faq"><strong style="font-size: 17px">Tôi có thể thay đổi thông tin hoặc
                            hủy đơn hàng không?</strong></button>
                    <div class="content_faq">
                        <p>Hoàn toàn có thể. Liên hệ ngay tổng đài dịch vụ chăm sóc khách hàng
                            <b>+84 123-456-789</b> của chúng
                            tôi
                            để được hỗ trợ thay đổi hoặc hủy đơn hàng kịp thời. Chúng tôi có thể thay đổi địa chỉ nhận
                            hàng, số điện thoại, thông tin nhận hàng. Chúng tôi không thể thêm sản phẩm vào một đơn hàng
                            hiện tại, tuy nhiên chúng tôi sẽ hỗ trợ bạn đặt lại một đơn hàng mới cho bất kỳ thông tin
                            hay sản phẩm bổ sung nào. Tìm hiểu thêm trong chính sách hoàn trả và hoàn tiền của chúng
                            tôi.</p>
                    </div>
                </div>
            </div>
