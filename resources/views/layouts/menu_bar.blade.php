			...
			<div class="align-items-center d-flex justify-content-between" style="min-height: 83px;">
					...
					<ul class="clearfix">
						<li>
							...
							<div id="menu">
								<ul>
									<li>
										<span><a href="{{route('product_list')}}">SẢN PHẨM</a></span>
									</li>
									<li>
										<span><a href="{{route('product_search', ['sex' => 'Nam'])}}">NAM</a></span>
									</li>
									<li>
										<span><a href="{{route('product_search', ['sex' => 'Nữ'])}}">NỮ</a></span>
									</li>
									<li>
										<span><a href="{{route('product_search', ['sex' => 'Phi giới tính'])}}">PHI GIỚI TÍNH</a></span>
									</li>
								</ul>
							</div>
						</li>
				...
				<div class="align-items-center d-flex flex-column" style="min-width: 300px;">
					<div id="logo" class="m-auto w-50">
						<a href="{{route('home')}}">
							<img class="swing" alt="logo" src={{asset('assets/img/logo-3.png')}} width="435" height="83"
